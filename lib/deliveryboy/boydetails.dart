...
class Boydetails extends StatefulWidget {
  const Boydetails({Key? key}) : super(key: key);

  @override
  State<Boydetails> createState() => _BoydetailsState();
}
...
class _BoydetailsState extends State<Boydetails> {
  @override
